		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "housekeeper",
									"targetURL": "#syncc201housekeeper-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc201housekeeper-display": {
								"semanticObject": "syncc201housekeeper",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c201.housekeeper",
									"url": sap.ui.require.toUrl("sync/c201/housekeeper")
								}
							}
						}
					}
